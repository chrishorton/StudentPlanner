...
class OnboardingViewController: UIViewController {
    ...
    var titleArray: [String] = ["Keep Track of Tasks", "Chat With Classmates", "A Social Planner"]
    var subTitleArray: [String] = ["StudyBuddy is made by a student to help you keep up with homework!", "Once you join a class, you are part of the group chat, with just students!", "Assignments that your classmates add will automatically be in your task list so you don't have to worry about forgetting!"]
...
extension OnboardingViewController: SwiftyOnboardDelegate, SwiftyOnboardDataSource {
    ...
    func swiftyOnboardPageForIndex(_ swiftyOnboard: SwiftyOnboard, index: Int) -> SwiftyOnboardPage? {
        ...
        if (index == 0) {
            view.imageView.image = UIImage.gif(name: "checkbox")
        } else if (index==1){
            view.imageView.image = UIImage.gif(name: "chat-question")
        } else {
